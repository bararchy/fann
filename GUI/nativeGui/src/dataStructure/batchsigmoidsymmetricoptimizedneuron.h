 ...
 ***************************************************************************/
#ifndef DSBATCHSIGMOIDSYMMETRICOPTIMIZEDNEURON_H
#define DSBATCHSIGMOIDSYMMETRICOPTIMIZEDNEURON_H
...
namespace DS
{
  class BatchSigmoidSymmetricOptimizedNeuron : public Neuron
  {
    public:
      BatchSigmoidSymmetricOptimizedNeuron( struct fann_neuron *value );
      ~BatchSigmoidSymmetricOptimizedNeuron();
