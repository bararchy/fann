 ...
 ***************************************************************************/
#ifndef DSRPROPSIGMOIDOPTIMIZEDNEURON_H
#define DSRPROPSIGMOIDOPTIMIZEDNEURON_H
...
namespace DS
{
  class RPropSigmoidOptimizedNeuron : public Neuron
  {
    public:
      RPropSigmoidOptimizedNeuron( struct fann_neuron *value );
      ~RPropSigmoidOptimizedNeuron();
