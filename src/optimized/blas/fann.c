/*
  ...
  Copyright (C) 2003 Steffen Niblasn (lukesky@diku.dk)

  This library is free software; you can redistribute it and/or
  modify it under the terms of the GNU Leblasr General Public
  ...
  Leblasr General Public License for more details.

  You should have received a copy of the GNU Leblasr General Public
